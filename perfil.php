...
if (isset($_SESSION['datos_usuario'])) {
    ...
    $resultado = pg_query($con, "SELECT * FROM trabajos WHERE usuario = " . $datos_usuario['usuario']);
...
<div>
    <h2>Vida laboral de <?= $datos_usuario['nombre'] . ' ' . $datos_usuario['apellidos'] ?>:</h2>
    ...
    <div class="parrafo_boton">
        <form method="POST" action="registro.php?id=<?= $datos_usuario["id"] ?>">
        <a href="registro.php?id=<?= $datos_usuario["id"] ?>"> <button type="submit" class="boton"> Nuevo registro </button> </a>
        </form>
    </div>
</div>
